...
const patientRoutes: RouteCase[] = [
  ...
  { name: 'telemedicine room', path: '/patient/telemedicine/00000000-0000-4000-8000-000000000601' },
...
const doctorRoutes: RouteCase[] = [
  ...
  { name: 'telemedicine room', path: '/doctor/telemedicine/00000000-0000-4000-8000-000000000601' },
