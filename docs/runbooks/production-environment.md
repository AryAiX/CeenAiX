...
| `SUPABASE_DEV_DATABASE_URL` | Optional full URL override | `postgresql://postgres:***@db.lgfaucsfiyxvmsghnpey.supabase.co:5432/postgres` (percent-encode password if set manually) |
